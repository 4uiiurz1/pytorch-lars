...
from schedulers import WarmupMultiStepLR, WarmupPolynomialLR
...
def parse_args():
    ...
    parser.add_argument('--linear-scaling', default=False, type=str2bool)
    parser.add_argument('--lars', default=False, type=str2bool)
...
def main():
    ...
    if args.name is None:
        args.name = '%s_WideResNet%s-%s_%d' %(args.dataset, args.depth, args.width, args.batch_size)
